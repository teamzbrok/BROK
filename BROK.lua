...
echo -e "\033[0;00m"
echo -e "\e[36m"
./tg -s ./BROK.lua -p PROFILE --bot=$token
done
]])  
file:close()  
file = io.open("BK", "w")  
...
if tonumber(user_id) == tonumber(1005274894) then  
var = true  
...
BOYKA_Msg = 'جيد نوعا ما ' 
elseif msgs < 400 then 
BOYKA_Msg = 'لا بأس تكبر وتتفاعل ' 
elseif msgs < 700 then 
BOYKA_Msg = 'جيد جدا وليدي' 
elseif msgs < 1200 then 
BOYKA_Msg = 'ءستمر حبيبي ' 
elseif msgs < 2000 then 
BOYKA_Msg = 'متفاعل وداعة ءلسيد ' 
...
BOYKA_Msg = 'ءطلق متفاعل ' 
elseif msgs < 7000 then 
BOYKA_Msg = 'ملك التفاعل' 
elseif msgs < 9500 then 
BOYKA_Msg = 'جفو منشاربك' 
...
--------------------------------------------------------------------------------------------------------------
function SourceBROK(msg,data) -- بداية العمل
if msg then
...
send(msg.chat_id_, msg.id_,'📌¦ عدد المجموعات الان » { '..#group..' }'..BROKK..''..BROK..'\n*📌| الان عدد المجموعات الحقيقي » { '..sendok..' } مجموعات\n')   
end
end
end,nil)
end
...
usertext = '\n👤| العضو » ['..result.title_..'](t.me/'..(username or 'xBROKK')..')'
...
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/xBROKK)}\n📛¦["..BOYKA_Msg.."] \n") 
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
if text and database:get(bot_id..'lock:Fshar'..msg.chat_id_) and not Manager(msg) then 
list = {"ك","ه","ت","ع","ح","و","ر","ض","ص","ن","س","ب","أ","ف","ذ","ظ","ط","ن","م","ز","غ"}
for k,v in pairs(list) do
print(string.find(text,v))
if string.find(text,v) ~= nil then
DeleteMessage(msg.chat_id_,{[0] = msg.id_}) 
...
send(msg.chat_id_,0, "⚠|عذرا يا » {["..data.first_name_.."](T.ME/xBROKK)}\n📮| الملصق الذي ارسلته تم منعه من المجموعه \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
🔖↬TeaM [ Z ]
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
📮↬[Channel BROK](t.me/xBROKK) 

👮‍♂️↬[DEVELOPER](t.me/wzzzz)

👮‍♂️↬[DEVELOPER Bot](t.me/w_zzbot)
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xBROKK')..') \n🔘| تـم قفـل الدردشه ')  
end,nil)   
...
elseif text == 'قفل العربيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:set(bot_id..'lock:Fshar'..msg.chat_id_,true) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xBROKK')..') \n🔘|  تـم قفـل العربيه ')  
end,nil)  
...
elseif text == 'فتح العربيه' and msg.reply_to_message_id_ == 0 and Manager(msg) then 
database:del(bot_id..'lock:Fshar'..msg.chat_id_) 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..utf8.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xBROKK')..') \n🔘| تـم فـتح العربيه  ')  
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'👤| بواسطه ← ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'xBROKK')..') \n🔘| تـم قفـل التاك بالكتم\n⛔| الحاله ←الكتم ')  
end,nil)   
...
if SudoBot(msg) then
local Get_Files, res = https.request("https://raw.githubusercontent.com/BOYKABOT/Files_Boyka/master/getfile.json")
if res == 200 then
local Get_info, res = pcall(JSON.decode,Get_Files);
vardump(res.plugins_)
if Get_info then
local TextS = "\n متجر ملفات سورس بروك  \n🔰| ملفات السورس ↓\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n\n"
local TextE = "\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n🔘|  علامة تعني { ✓ } ملف مفعل\n🔘| علامة تعني { ✘ } ملف معطل\n🔖| سورس بروك  ↓\n".."📮| [اضغط هنا لدخول](t.me/xBROKK) \n"
local NumFile = 0
...
local json_file, res = https.request("https://raw.githubusercontent.com/BOYKABOT/Files_Boyka/master/File_Bot/"..file)
if res == 200 then
os.execute("rm -fr File_Bot/"..file)
send(msg.chat_id_, msg.id_,t) 
dofile('BROK.lua')  
else
send(msg.chat_id_, msg.id_,"⚠️| عذار هاذا ملف ليس من ملفات سورس بروك\n") 
end
return false
end
...
send(msg.chat_id_, msg.id_,"⚠️|  عذرا هاذا ملف ليس من ملفات سورس بروك\n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
usertext = '\n👤| العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'xBROKM')..')'
status  = '\n📮| الايدي » `'..result.sender_user_id_..'`\n⚡| تم تنزيل العضو بقره\nتعال هاك حليب مالتك'
send(msg.chat_id_, msg.id_, usertext..status)
end,nil)
end
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بروك').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'بروك')
local BOYKA_Msg = {
'اسمي. بروك كول 💘؟',
'داشتغل حبي لتزعجني؟ ',
'صاعد وي زهو باي ',
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'بروك').." غادر" then  
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'بروك')
...
BROK = https.request("https://api.telegram.org/bot"..token.."/kickChatMember?chat_id="..msg.chat_id_.."&user_id="..mem_id[i].id_)
local Json_Info = JSON.decode(BROK)
...
------------------------------------------------------------------------
local BROKbot = database:get(bot_id.."Add:Filter:Rp2"..text..result.chat_id_)   
if BROKbot then    
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(arg,data) 
if data.username_ ~= false then
send(msg.chat_id_,0,"⚠¦العضو : {["..data.first_name_.."](T.ME/"..data.username_..")}\n📛¦["..BROKbot.."] \n") 
